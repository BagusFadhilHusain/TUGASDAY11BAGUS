    ...
    void klik(){
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SayaActivity.this, MainActivity.class);
        ...
        descriptionButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SayaActivity.this, FileActivity.class);
                startActivity(intent);
            }
        });
        ...
        widgetsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SayaActivity.this, AlatActivity.class);
                startActivity(intent);
            }
        });
